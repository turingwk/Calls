...
class RongDatabaseDao {
    ...
    UserInfo getUserInfo(String userId) {
        if(userId == null) {
            ...
            Cursor c = this.db.query("users", (String[])null, "id = ?", new String[]{userId}, (String)null, (String)null, (String)null);
            UserInfo info = null;
            if(c != null) {
                if(c.moveToFirst()) {
    ...
    synchronized void putUserInfo(UserInfo userInfo) {
        if(userInfo != null && !TextUtils.isEmpty(userInfo.getUserId())) {
            if(this.db == null) {
                ...
                } catch (SQLiteFullException var3) {
    ...
    GroupUserInfo getGroupUserInfo(String groupId, String userId) {
        if(userId != null && groupId != null) {
            if(this.db == null) {
                ...
                Cursor c = this.db.query("group_users", (String[])null, "group_id = ? and user_id = ?", new String[]{groupId, userId}, (String)null, (String)null, (String)null);
    ...
    Group getGroupInfo(String groupId) {
        if(groupId == null) {
            ...
            Cursor c = this.db.query("groups", (String[])null, "id = ?", new String[]{groupId}, (String)null, (String)null, (String)null);
            Group group = null;
            if(c != null) {
                if(c.moveToFirst()) {
                    String id = c.getString(c.getColumnIndex("id"));
    ...
    Discussion getDiscussionInfo(String discussionId) {
        if(discussionId == null) {
            ...
            Cursor c = this.db.query("discussions", (String[])null, "id = ?", new String[]{discussionId}, (String)null, (String)null, (String)null);
